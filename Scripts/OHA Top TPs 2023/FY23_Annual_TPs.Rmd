...
20. In 2023, local partners conducted almost **21.1 million** [**`r hts_lp_value`**] HIV tests, to help people learn their HIV status. 
...
30. Since 2018, USAID has supported programs that resulted in more than 2.7 million cervical cancer screenings for WLHIV under the PEPFAR supported Go Further Initiative. As of September 30, 2023, nearly two million women on life-saving HIV medication have been screened for cervical cancer by USAID programs. Nearly 90,000 women were found to have precancerous lesions, and of those, 74% received treatment.(*check separately with cxca code*)
